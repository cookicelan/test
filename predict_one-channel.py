...
if __name__ == "__main__":
    detr = Detection_Transformers(model_path='model_data/ep200-loss0.714-val_loss1.014_V4.pth',confidence=0.7)
    ...
    # -------------------------------------------------------------------------#
    dir_origin_path = r"E:\李\BRC公司记录\公司安排\比亚迪\比亚迪音频文件\spectro（时频图待标注）"
    dir_save_path = r"E:\李\BRC公司记录\公司安排\比亚迪\比亚迪音频文件\模型推理结果\200数据量训练集V4"
