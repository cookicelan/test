...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = 'model_data/ep200-loss1.045-val_loss1.164_V1.pth'
    # ------------------------------------------------------#
    ...
    if True:
        ...
        # ----------------------#
        if local_rank == 0:
            eval_callback = EvalCallback(model, min(input_shape[0], input_shape[1]), class_names, num_classes,
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, detr_loss, loss_history, eval_callback, optimizer, epoch, epoch_step,
                          epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period,
                          save_dir, local_rank)
